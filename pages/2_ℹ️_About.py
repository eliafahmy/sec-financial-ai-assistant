...
pages/2_ℹ️_About.py
=====================
صفحة ملخص عن المشروع: الفكرة، المصادر، والتقنيات المستخدمة.
"""
...
from app_common import init_session_state, inject_css, render_sidebar_brand, render_sidebar_footer, render_lang_theme_controls

st.set_page_config(page_title="About - SEC Financial Assistant", page_icon="ℹ️", layout="centered")
